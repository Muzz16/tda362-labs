...
void display()
{
	...
	mat4 rotation = glm::rotate(float(currentTime * M_PI * -0.5f), vec3(0.0f, 1.0f, 0.0f));
	mat4 transform = glm::translate(vec3(20.0f, 0.0f, 0.0f));
	mat4 transform2 = glm::translate(vec3(rotation * vec4(10.0f, 0.0f, 0.0f, 1.0f)));
	mat4 carModelMatrix2 = transform * transform2 * rotation;
